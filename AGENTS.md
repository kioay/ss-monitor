...
- Production should use only the lightweight BettaFish semantic model subset. Sync it with `npm run sync:bettafish-semantic`; do not upload BettaFish crawler trees, browser profiles, cookies, media downloads, or training datasets to the 20G production server.
