...
3. Prioritize real visual material: videos, thumbnails, image posts, weapon skin showcases, character skin showcases, inspect animations, kill effects, store bundles, battle pass skins, concept renders, and official/fan visual previews.
   ...
   Reject market analysis, price charts, price trends, trading, investment, auction, and buy/sell commentary. A thumbnail showing skin items or weapon names is not sufficient when the content is about prices, transactions, or a creator's commentary rather than visual design.
   Reject keyboards, mice, mouse pads, keycaps, headsets, monitors, controllers, gaming chairs, and other peripheral merchandise or hardware collaborations. A game IP, esports team, `联名`, or `套装` label does not make a peripheral product image a design reference, and such images must not be selected for channel thumbnail artifacts.
